  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form method="post" id="folder_form" action="<?php echo WEB_DIR;?>FolderCreation/create_root_node">
		...
		Folder Name<input type="text" value="" required="required" minlength="4" maxlength="10" name="dept_name" pattern="[a-zA-Z0-9-]+" id="dept_name" class="form-control">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">	
	   ...
	   <form method="post" id="modelFormEdit" action="<?php echo WEB_DIR;?>FolderCreation/edit_root_node">
		...
		Department Name<input type="text" value="" name="dept_name_edit" id="dept_name_edit" class="form-control">
