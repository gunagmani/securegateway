                             ...
                             <div class="table-responsive">
                                <table class="table table-striped" id="example">
									...
									?>
										...
										<a data-toggle="modal" data-id="<?php echo $id; ?>" title="File Share" class="open-AddBookDialog btn btn-info" href="#addBookDialog">Add Node</a>
    ...
    <div class="modal-content">
	  ...
	  <div id="email_div">
	   ...
	   <form method="post" id="modelForm" action="<?php echo WEB_DIR;?>/FolderCreation/departmentCreate">
		...
		<input type="text" value="" name="dept_name" data-role="tagsinput" id="dept_name" class="form-control">
      </div>
