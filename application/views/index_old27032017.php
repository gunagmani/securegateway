        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-6 col-md-offset-3 pad-bottom" data-scroll-reveal="enter from the bottom after 0.2s">
					...
					<div class="section-title">
						<h1 class="wow BounceInDown" data-wow-duration="2s" data-wow-delay="5s">AWESOME <strong>FEARURES</strong></h1>
						<div class="divider"></div>
					</div>
            ...
            <div class="row">
                <div class="col-md-12">
						...
						<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure1.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure2.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure3.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure4.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure5.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure6.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure7.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure8.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure9.png" alt="Image"/></div>
	<div class="item"><img class="img-responsive" src="<?php echo WEB_DIR;?>/assets/images/secure10.png" alt="Image"/></div>
</div>	
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="db-bk-color-two">Personal</th>
