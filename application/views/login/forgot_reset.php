      ...
      <div class="col-md-4 right-side">
        <div id="first">			
				<div class="section-title">
					...
					<form data-parsley-validate method="post" action="<?php echo WEB_DIR;?>Securegateway/forgotreset/">
        ...
        <span class="input input--hoshi">
          <input class="input__field input__field--hoshi" type="password" name="password1" id="re_password" data-parsley-equalto="#newpass" data-parsley-required-message="Retype the password" required />
