	  ...
	  <div id="success"><?php echo $this->messages->getMessageFront(); ?></div>
        <div id="first">			
			...
			<input type="submit" class="btn btn-primary pull-left" value="Sign-In">
				...
				<p id="one"><a href="<?php echo WEB_DIR;?>Securegateway/view_forgot">Forget Password ?</a></p>
		...
		<span id="utype" class="input input--hoshi">
          ...
          <label class="input__label input__label--hoshi input__label--hoshi-color-3" for="usertype1">
            <span class="input__label-content input__label-content--hoshi">Account Type</span>
          </label>
        </span>
			</div>   <!-- Free User Block   -->
		<div id="other-block">
