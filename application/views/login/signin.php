...
<div id="main-wrapper">
  ...
  <div class="container-fluid">
    <div class="row">
	  ...
	  <div class="row">
	  		<div class="col-md-6" >
					<a href="<?php echo $this->googleplus->loginURL();?>" onclick="JavaScript:Void(0);"><img style="margin-top:8px;" src="<?php echo WEB_DIR;?>assets/sign_in_gp.jpg" width="300"></a>
					</div>
					
					<div class="col-md-6"><a href="<?php echo $this->facebook->login_url();?>" onclick="JavaScript:Void(0);"><img src="<?php echo WEB_DIR;?>assets/sign_in_fb.png" width="300"> </a>	</div>  </div>  
        ...
        <div id="first">			
				...
				<form data-parsley-validate  method="post" id="signin_form" action="<?php echo WEB_DIR;?>Securegateway/login/">
			<span class="input input--hoshi">
			  <input class="input__field input__field--hoshi" type="text" id="email" name="email" data-parsley-type="email"  required />
			  <label class="input__label input__label--hoshi input__label--hoshi-color-3" for="email">
				<span class="input__label-content input__label-content--hoshi">E-mail</span>
			  </label>
			</span>
			<span class="input input--hoshi">
			  <input class="input__field input__field--hoshi" type="password" name="pwd" id="password" data-type="password" required  />
			...
			<input type="submit" class="btn btn-primary pull-left" value="Sign-In">
				...
				<p id="one"><a href="<?php echo WEB_DIR;?>Securegateway/view_forgot">Forgot Password ?</a></p>
	   ...
	   <div id="email_error" class="error_message" >
		...
		<span class="input input--hoshi">
          <input class="input__field input__field--hoshi" type="password" name="password" id="newpass" data-parsley-length="[6, 10]" autocomplete="off"/>
          <label class="input__label input__label--hoshi input__label--hoshi-color-3" for="password">
            <span class="input__label-content input__label-content--hoshi">Password</span>
          </label>
        </span>
        ...
        <span class="input input--hoshi">
          <input class="input__field input__field--hoshi" type="password" name="password" id="re_password" data-parsley-equalto="#newpass" data-parsley-required-message="Retype the password" data-parsley-length="[6, 10]"   autocomplete="off"/>
	...
	<!--
        ...
        <span class="input input--hoshi">
		  ...
		  <span class="input input--hoshi">
									...
									<option value="">User Type</option>									<option value="1">Free</option>
									<option value="2">Personal</option>
		...
		$.ajax({
                    ...
                    if(data==2)
						...
						else if(data==1)
						{
							...
							$("#email_error").removeClass("error_message");
