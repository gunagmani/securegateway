	  ...
	  <div id="success"><?php echo $this->messages->getMessageFront(); ?></div>
        <div id="first">			
				<div class="section-title">
					...
					<form data-parsley-validate method="post" action="<?php echo WEB_DIR;?>DashboardGuestUser/guestemail_otp/">
		...
		<!--	<div class="input input--hoshi">
			...
			<div class="cta">
			<input type="submit" id="otp_sub" class="btn btn-primary pull-left"  value="validate">		  
			</div>
