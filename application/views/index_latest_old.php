...
<div id="wrapper" class="">		
    ...
    <div class="container-fluid">
		...
		<img src="<?php echo WEB_DIR;?>assets/images/home/securegateway.jpg" class="img-responsive">
		</div>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-6 col-md-offset-3 pad-bottom" data-scroll-reveal="enter from the bottom after 0.2s">
                  ...
                  <!--  <h2 class="wow BounceInDown" data-wow-duration="2s" data-wow-delay="5s">AWESOME <strong>FEARURES</strong></h2> -->
            ...
            <div class="row text-center pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
			 ...
			 <div class="col-md-12">
			 		<img src="<?php echo WEB_DIR;?>assets/images/home/securegatewayfeature.jpg" class="img-responsive">
			 </div>
              <!--  <div class="col-md-4">
