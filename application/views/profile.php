...
<div id="success"><?php echo $this->messages->getMessageFront(); ?></div>
	...
	<div class="row" id="securewrapper">
      ...
      <input name="otp_option" type="checkbox" id="test2" class="form-control col-lg-11 filled-in" id="filled-in-box" <?php if($otp_option==1){
		  echo 'checked="checked"';
	  }		  ?>>
      <label for="test2">2 Factor Authenciation</label>
